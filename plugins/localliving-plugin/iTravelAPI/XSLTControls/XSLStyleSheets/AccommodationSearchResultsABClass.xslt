    ...
    <xsl:choose>
      <xsl:when test="$totalResults > 0">
        <section class="a-class">
          <h2>A klasse boliger</h2>
          <xsl:choose>
            <xsl:when test="/*/AccommodationObjectList/AccommodationObject/AClass">
              <xsl:for-each select="/*/AccommodationObjectList/AccommodationObject/AClass">
...
<!--                </xsl:if>-->
                  ...
                  <div class="article-wrapper {$region-hor-line-class}">
                    <article class="row search-results-row">
                      ...
                      <div class="col-md-2 last-column">
                        ...
                        <xsl:choose>
                          <xsl:when test="$countUnit &lt;= $countOversizedUnit">
                            <button class="add-to-cart not-possible" disabled="disabled">Ikke mulig</button>
                          </xsl:when>
                          <xsl:otherwise>
                          ...
                          <xsl:if
                            ...
                            <article>
                              <div class="row">
                                ...
                                <div class="col-md-5">
                                  <div class="villa-unit-desc">
                                    ...
                                    <!--Unit description-->
                                    <a href="#" class="show-hide-unit-description" onClick="return false;">Vis beskrivelse
                                    </a>
                                    <xsl:choose>
                              ...
                              CalculatedPriceInfo/CalculationStatus/Code = 'Error' or $errorType = 'notAvailable'">
                                        ...
                                        <xsl:otherwise>
                                          <button class="add-to-cart" data-object-id="{$objectID}" data-unit-id="{UnitID}">
                                            Vælg
                                          </button>
                                        </xsl:otherwise>
                                      </xsl:choose>
            ...
            <xsl:otherwise>
              <div class="not-found">
                <p>Der er ingen A-klasse indkvartering, der passer til dine søgekriterier.</p>
              </div>
            </xsl:otherwise>
          </xsl:choose>
        </section>

        <section class="b-class">
          <h2>B klasse boliger</h2>
          <xsl:choose>
            <xsl:when test="/*/AccommodationObjectList/AccommodationObject/BClass">
              <xsl:for-each select="/*/AccommodationObjectList/AccommodationObject/BClass">
                <xsl:variable name="ImageSource" select="PhotoList/Photo[1]/ThumbnailUrl"/>
                <xsl:variable name="AlternateText" select="PhotoList/Photo[1]/AlternateText"/>
                <xsl:variable name="AccommodationName" select="Name"/>
                <xsl:variable name="objectURL" select="ObjectURL"/>
...
<!--                </xsl:if>-->
            ...
            <xsl:otherwise>
              <div class="not-found">
                <p>Der er ingen B-klasse indkvartering, der passer til dine søgekriterier.</p>
              </div>
            </xsl:otherwise>
          </xsl:choose>
        </section>
