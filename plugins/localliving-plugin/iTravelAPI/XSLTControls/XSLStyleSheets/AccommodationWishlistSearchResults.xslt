					...
					<article class="row search-results-row">
							...
							<div class="col-md-8">
								...
								<div class="row">
									...
									<div class="col-md-6 text-right heading-caps" style="display:none;">
										<xsl:variable name="Minimal_CalculatedPriceInfo">
											<xsl:for-each select="UnitList/AccommodationUnit/CalculatedPriceInfo[CalculatedPrice &gt; 0]/CalculatedPrice">
										...
										<!--Regular price-->
										<div class="object-price" style="float:right;">
