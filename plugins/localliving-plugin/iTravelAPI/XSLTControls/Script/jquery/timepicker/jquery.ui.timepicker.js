...
(function ($) {
    ...
    jQuery.extend(jQuery.ui, { timepicker: { version: "0.3.2"} });
...
*/
        ...
        _checkExternalClick: function (event) {
            ...
            if ($target[0].id != jQuery.timepicker._mainDivId &&
				$target.parents('#' + jQuery.timepicker._mainDivId).length == 0 &&
				!$target.hasClass(jQuery.timepicker.markerClassName) &&
				!$target.hasClass(jQuery.timepicker._triggerClass) &&
        ...
        */
        ...
        selectHours: function (event) {
            var $td = jQuery(event.currentTarget),
            ...
            if ( jQuery.timepicker._isDisabledTimepicker($target.attr('id')) ) { return false }
    ...
    jQuery.timepicker.version = "0.3.2";
